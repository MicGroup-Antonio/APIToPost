...
/**
 * Helper functions for transmission windows configuration
 */
 ...
 */
export async function configureTransmissionWindows(ask, existingWindows = null) {
  console.clear();
  ...
  console.log(chalk.white("  - Start time (HH:MM format, e.g., 12:00)"));
  console.log(chalk.white("  - End time (HH:MM format, e.g., 13:00)"));
