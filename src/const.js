...
export const CODE_C_NTP = "0a"; // CONFIGURACIÓN - NTP
export const CODE_C_RSER = "0b"; // CONFIGURACIÓN - Parámetros Servidor Remoto
export const CODE_C_TRSER = "0c"; // CONFIGURACIÓN - Parámetros Servidor Remoto Temporal
export const CODE_C_TMAX = "0d"; // CONFIGURACIÓN - Tiempo Máximo Conexión
export const CODE_C_TTMAX = "0e"; // CONFIGURACIÓN - Tiempo Máximo Conexión Temporal
export const CODE_C_WMBUS = "0f"; // CONFIGURACIÓN - Tiempo de Lectura WMBUS
